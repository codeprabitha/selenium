...
public class TestBase {
	...
	static {
		...
		extent = new ExtentReports(System.getProperty("user.dir") + "/src/main/java/com/aconexAutomation/report/" + formater.format(calendar.getTime()) + ".html", false);//false is to retain report
	...
	public void loadPropertiesFile() throws IOException {
		...
		OR = new Properties();
		f1 = new File(System.getProperty("user.dir") + "/src/main/java/com/aconexAutomation/config/config.properties");
	...
	public String getScreenShot(String imageName) throws IOException {
		...
		String imagelocation = System.getProperty("user.dir") + "/src/main/java/com/aconexAutomation/screenshot/";
		Calendar calendar = Calendar.getInstance();
		SimpleDateFormat formater = new SimpleDateFormat("dd_MM_yyyy_hh_mm_ss");
	...
	public void endTest() {
		driver.quit();
		extent.endTest(test);
		extent.flush();//write data to html report
	}
